...
import sys
import argparse
from dataset import MVP_CP, MVP_CP_EX
...
def train():
    ...
    dataset = MVP_CP_EX(prefix="train")
    dataset_test = MVP_CP_EX(prefix="val")
    ...
    for epoch in range(args.start_epoch, args.nepoch):
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            label, inputs, gt, voxels, coords = data
            # mean_feature = None
            ...
            out2, loss2, net_loss = net(inputs, gt, label=label, voxels=voxels, coords = coords)
...
def val(net, curr_epoch_num, val_loss_meters, dataloader_test,
    ...
    with torch.no_grad():
        for i, data in enumerate(dataloader_test):
            ...
            result_dict = net(inputs, gt, label = label, voxels = voxels, coords = coords, prefix="val")
